# Ansible Role: vlag_2tier_leaf - Multiple Layer vLAG Leaf Configuration
---
...
- /etc/ansible/hosts - You must edit the */etc/ansible/hosts* file with the device information of the switches designated as leaf switches. You may refer to *vlag_2tier_leaf_hosts* for a sample configuration.
...
```
ansible-playbook vlag_2tier_leaf.yml -vvv
```
